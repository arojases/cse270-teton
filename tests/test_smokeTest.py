...
class TestSmokeTest():
  ...
  def test_adminPageTest(self):
    ...
    self.driver.set_window_size(1276, 1028)
    self.driver.find_element(By.LINK_TEXT, "Admin").click()
    elements = self.driver.find_elements(By.ID, "username")
    assert len(elements) > 0
    self.driver.find_element(By.ID, "username").send_keys("ariel")
  ...
  def test_directoryPageTest(self):
    self.driver.get("http://127.0.0.1:5500/teton/1.6/index.html")
    self.driver.set_window_size(1279, 1031)
  ...
  def test_homePageTest(self):
    self.driver.get("http://127.0.0.1:5500/teton/1.6/index.html")
    self.driver.set_window_size(1269, 1029)
  ...
  def test_joinPageTest(self):
    self.driver.get("http://127.0.0.1:5500/teton/1.6/index.html")
    self.driver.set_window_size(1275, 1021)
    self.driver.find_element(By.LINK_TEXT, "Join").click()
    elements = self.driver.find_elements(By.NAME, "fname")
    assert len(elements) > 0
    self.driver.find_element(By.NAME, "fname").send_keys("Ariel")
    self.driver.find_element(By.NAME, "lname").send_keys("Rojas")
    self.driver.find_element(By.NAME, "bizname").send_keys("Ariel Rojas LLC")
